let app = new Vue({
    ...
    data: {
        areas: [
            {id:'east-wall', name:'East Wall Group', map: 'https://www.google.com/maps/d/u/1/embed?mid=1L-zP6_a6bHyZiInQp_2Pp_y-x9siffAW&z=15&ll=53.3601161,-6.2383579', bridges: [
                {
                    id: 'john-mccormack',
                    name: 'John McCormack',
                    number: '3024',
                    ...
                    entry: 'Ladder required, climb down wall (approximately 5m)',
                    gear: 'Drysuit required, possibly waders',
                    width: '13m',
                    length: '20m',
                    image1: './dist/img/jm1.jpg',
                    image2: './dist/img/jm2.jpg',
                    image3: './dist/img/jm3.jpg'
                },
                {
                    ...
                    parking: 'On street, pay and display',
                    entry: 'Ladder in place',
                    gear: 'Waders',
                    width: '1.5m',
                    length: '20m',
                    image1: './dist/img/fb-ew1.jpg',
                    image2: './dist/img/fb-ew2.jpg',
                    image3: './dist/img/fb-ew3.jpg'
                },
                {
                    id: 'annesley',
                    name: 'Annesley',
                    ...
                    parking: 'On street, pay and display',
                    entry: 'Ladder in place',
                    gear: 'Waders, possibly wellies',
                    width: '13m',
                    length: '20m',
                    image1: './dist/img/an1.jpg',
                    image2: './dist/img/an2.jpg',
                    image3: './dist/img/an3.jpg'
                },
                {
                    id: 'luke-kelly',
                    name: 'Luke Kelly',
                    ...
                    width: '20m',
                    length: '30m',
                    image1: './dist/img/lk1.jpg',
                    image2: './dist/img/lk2.jpg',
            ...
            {id:'liffey-inner', name:'Liffey Inner City', map: 'https://www.google.com/maps/d/u/1/embed?mid=15Q1wbF7-z62dXERxaTQTMw7PZRiwhzS3&z=12.5&ll=53.3459305,-6.3073188', bridges: [
                {
                    ...
                    parking: 'On street, pay and display',
                    entry: 'Ladders in place',
                    gear: 'Unknown depth',
                    width: '20m',
                    length: '40m',
                    image1: './dist/img/cpg1.jpg',
                    image2: './dist/img/cpg2.jpg',
                    image3: './dist/img/cpg3.jpg'
                },
                {
                    id: 'james-joyce',
                    name: 'James Joyce',
                    ...
                    width: '20m',
                    length: '30m',
                    image1: './dist/img/jj1.jpg',
                    image2: './dist/img/jj2.jpg',
                    image3: ''
                },
                {
                    id: 'rory-omore',
                    ...
                    station:'Top of walls, minimum 1 move required',
                    parking: 'On street, pay and display',
                    entry: 'Ladders and stairs in place',
                    gear: 'Unknown depth',
                    width: '10m',
                    length: '30m',
                    image1: './dist/img/rm1.jpg',
                    image2: './dist/img/rm2.jpg',
                    image3: './dist/img/rm3.jpg'
                },
                {
                    id: 'frank-sherwin',
                    name: 'Frank Sherwin',
                    ...
                    width: '15m',
                    length: '50m',
                    image1: './dist/img/fs1.jpg',
                    image2: './dist/img/fs2.jpg',
                    image3: './dist/img/fs3.jpg'
                }
            ]},
            {id:'grand-canal', name:'Grand Canal', map: 'https://www.google.com/maps/d/u/1/embed?mid=1y9R2pnh9NqUoPQ6pZ5Qlms0HGSJaXy8j&z=17&ll=53.3297901,-6.2750782', bridges: [
                {
                    id: 'emmet',
                    name: 'Emmet Bridge',
                    number: '5071',
                    ...
                    width: '12m',
                    length: '15m',
                    image1: './dist/img/em1.jpg',
                    image2: './dist/img/em2.jpg',
            ...
            {id:'north-city', name:'North Dublin', map: 'https://www.google.com/maps/d/u/1/embed?mid=1HFfsjHbKwWtqcf-zUBWvX2w4Pmwiyyy1&z=12&ll=53.374498796510686,-6.29373751767579', bridges: [
                {
                    ...
                    tidal: 'Yes',
                    station:'In riverbed, 1 move required',
                    parking: 'On street, pay and display (coin only)',
                    entry: 'Ladder required, climb down wall (approximately 5m)',
                    gear: 'Drysuit required, possibly waders',
                    width: '13m',
                    length: '20m',
